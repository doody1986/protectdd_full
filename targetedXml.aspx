<%@ Page Language="C#" AutoEventWireup="true" CodeFile="targetedXml.aspx.cs" Inherits="protectdd_targetedXml" %>
                            ...
                            $(this).find("field").each(function () {
                                ...
                                $(this).find("fieldValues").each(function () {
                                    ...
                                    $(this).find("fieldData").each(function () {
                                        ...
                                        if ($(this).find("fieldValue").text() != $(this).find("fieldValueLabel" + language).text()) {

                                            constructionString += '<div class="fieldValueSection">(' + $(this).find("fieldValue").text() + ') ' + $(this).find("fieldValueLabel" + language).text() + '</div>';
                                        } else {


                                            constructionString += '<div class="fieldValueSection">' + $(this).find("fieldValue").text() + '</div>';
                                        }
